                ...
                <div class="card-body">
                    <form action="index.php?controlador=configuracion&accion=<?php echo $accion; ?><?php echo $id ? '&id=' . $id : ''; ?>" method="POST">
                        <div class="form-group mb-3">
                            <label for="nombre">Nombre del Arancel:</label>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="descripcion" name="descripcion" rows="3" required><?php echo isset($arancel) ? $arancel['descripcion'] : ''; ?></textarea>
                                        ...
                                        <div class="form-group mb-3">
                            <label for="monto_antes_22">Monto antes de las 22hs ($):</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="monto_despues_22">Monto después de las 22hs ($):</label>
                        ...
                        <div class="form-group mt-4">
                            <a href="index.php?controlador=configuracion&accion=listarAranceles" class="btn btn-secondary">Cancelar</a>
